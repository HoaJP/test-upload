...
#include <WiFi.h>
#include <string.h>
const char* ssid ="S21 của Khánh";     //"PTIT_LAB DAO TAO";
const char* password ="11112003";   //"buuchinh@" ;
#define DHTPIN 14     // Digital pin connected to the DHT sensor
#define DHTTYPE DHT11   // DHT 11
 
DHT dht(DHTPIN, DHTTYPE);
String UrlThingspeak = "https://api.thingspeak.com/update?api_key=IVTF5BE8RJSPFICZ&field1=0";
